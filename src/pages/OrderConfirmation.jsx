...
const OrderConfirmation = ({deliveryDetails}) => {
  return <>
    <div className="container mx-auto md:px-8 pt-12">
      <div className="p-12 bg-gray rounded-3xl shadow-2xl max-w-2xl mx-auto text-center mt-12 border border-green-700 text-white">
        ...
        <Link to={"/checkout"} className="mt-10 px-10 py-4 bg-orange-600 rounded-full text-white font-extrabold rounnded-full shadow-lg shadow-orange-800/50 cursor-pointer hover:bg-orange-700 transition duration-300 flex items-center justify-center space-x-2 transform hover:ring-4 hover:ring-pint-600/50 tracking-wider"
                    >Continue Shopping
                    </Link>
      </div>
    </div>
